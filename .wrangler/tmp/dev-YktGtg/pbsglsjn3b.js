// .wrangler/tmp/bundle-aqFdI7/checked-fetch.js
...
// .wrangler/tmp/pages-NfdavU/bundledWorker-0.29927940278766285.mjs
...
async function k(e, { request: t, assetsFetcher: a, ctx: s }, { path: r, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = P(await a.fetch(A(c, e.path ?? r))), e.headers && _(n.headers, e.headers);
        break;
      }
      case "static": {
...
async function K(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = z(e, fe), n = await s.get(r, { softTags: i });
      ...
      case "POST": {
        let i = await e.json();
        return i.data.tags === void 0 && (i.tags ??= z(e, pe) ?? []), await s.set(r, i), new Response(null, { status: 200 });
      }
      default:
...
function ge() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await K(a), s) ? s : (_e(a), e(a));
  };
}
async function ye(e) {
...
var E = class {
  ...
  applyRouteDest(t, a, s) {
    ...
    return R(this.searchParams, U.searchParams), b(this.path) || (this.path = U.pathname), r;
  }
...
var ns = { async fetch(e, t, a) {
  ...
  return s.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: w }, async () => {
    ...
    let i = D(e);
    return Q({ request: i, ctx: a, assetsFetcher: t.ASSETS }, f, m, g);
  });
} };
...
// .wrangler/tmp/pages-NfdavU/pbsglsjn3b.js
...
// .wrangler/tmp/bundle-aqFdI7/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-aqFdI7/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=pbsglsjn3b.js.map
